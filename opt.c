 ...
 * -f     --fractal   yes        fractal type (renders just single fractal)
 * -p     --pattern   yes        pattern type (renders just single pattern)
 * -i     --filter    yes        filter type (only one filter can be applied)
 * -c     --color     yes        color palette name (palette to be used for rendered fractal or pattern)
 *
 * -s     --scene     yes        name of scene definition file
 *
...
int main(int argc, char *argv[]) {
  ...
  while (1) {
    ...
    static struct option long_options[] = {
        ...
        {"scene", required_argument, NULL, 0},
