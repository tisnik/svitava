...
void test_filter_edge_detection_3x3_3_null_image(void) {
    TEST_BEGIN
    /* Should not crash */
    filter_edge_detection_3x3_3(NULL);
    TEST_END
}
...
/**
 * Ensure filter_vertical_edge_detection_3x3 safely handles a NULL image without crashing.
 */
void test_filter_vertical_edge_detection_3x3_null_image(void) {
    TEST_BEGIN
    /* Should not crash */
    filter_vertical_edge_detection_3x3(NULL);
    TEST_END
}

/**
 * Checks that filter_vertical_edge_detection_3x3 safely handles an image whose pixel buffer is NULL.
 *
 * Constructs an image with valid width, height, and RGB bpp but a NULL pixels pointer, then calls
 * filter_vertical_edge_detection_3x3 to ensure the function does not crash or exhibit undefined behavior.
 */
void test_filter_vertical_edge_detection_3x3_image_without_pixels(void) {
    TEST_BEGIN
    image_t image;
    image.width = 10;
    image.height = 10;
...
/**
 * Checks that filter_horizontal_sobel_operator_3x3 safely handles an image whose pixel buffer is NULL.
 *
 * Constructs an image with valid width, height, and RGB bpp but a NULL pixels pointer, then calls
 * filter_horizontal_sobel_operator_3x3 to ensure the function does not crash or exhibit undefined behavior.
 */
void test_filter_horizontal_sobel_operator_3x3_image_without_pixels(void) {
    TEST_BEGIN
    image_t image;
    image.width = 10;
    image.height = 10;
...
int main(void) {
    ...
    test_filter_vertical_edge_detection_3x3_null_image();
